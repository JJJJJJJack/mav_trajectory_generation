#ifndef MAV_TRAJECTORY_GENERATION_WAYPOINTS_PLANNER_H
#define MAV_TRAJECTORY_GENERATION_WAYPOINTS_PLANNER_H
...
class WaypointsPlanner {
 public:
  WaypointsPlanner(ros::NodeHandle& nh);
...
#endif // MAV_TRAJECTORY_GENERATION_WAYPOINTS_PLANNER_H
